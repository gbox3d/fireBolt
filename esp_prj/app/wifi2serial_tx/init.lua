dofile('gpio.lua')dofile('wifi_setup.lua')dofile('u2u.lua')
function startup()
    ...
    tmr.alarm(0,500,1,
        ...
        print('dmode')gpio.write(pin_ap_led,gpio.LOW)gpio.write(pin_connection_led,gpio.HIGH)start_configServer(1471)
    end
end
startup()
